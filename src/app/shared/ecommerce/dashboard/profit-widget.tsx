...
const topDueCustomers = [
  { name: 'Customer A', due: '6,500,000', dueIn: '60 days' },
  { name: 'Customer B', due: '4,500,000', dueIn: '30 days' },
  { name: 'Customer C', due: '3,500,000', dueIn: '90 days' },
];
...
export default function ProfitWidget({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <div className="grid flex-grow grid-cols-1 gap-3">
        <div className="mt-4 p-4 rounded-lg bg-white  duration-300">
          <h3 className="text-lg font-semibold mb-2">Top Due Customers</h3>
